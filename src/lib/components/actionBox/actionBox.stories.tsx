...
const TemplateRight: ComponentStory<typeof ActionBox> = (args) => <RightPos><ActionBox {...args} /></RightPos>;
...
const AvatarRight: ComponentStory<typeof ActionBox> = (args) => <RightPos><ActionBox {...args} /></RightPos>;
