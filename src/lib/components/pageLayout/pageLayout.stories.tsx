...
const Template: ComponentStory<typeof PageLayout> = (args) => {
    return (
        <PageLayout {...args} >
            <PageLayout.Header><Blank height={100}>PageLayout.Header</Blank></PageLayout.Header>
            <PageLayout.Content><Blank height={500}>PageLayout.Content</Blank></PageLayout.Content>
            <PageLayout.Pane><Blank height={500}>PageLayout.Pane</Blank></PageLayout.Pane>
            <PageLayout.Footer><Blank height={100}>PageLayout.Footer</Blank></PageLayout.Footer>
        </PageLayout>
    )
};
